...
const Navbar4 = () => {
  ...
  const navbarStyle = expandedDropdown
    ? { height: "auto" } // Adjust navbar height when dropdown is expanded
    : {};

  const dropdownStyle = expandedDropdown
    ? { maxHeight: "none" } // Allow the dropdown to expand to its content
    : {};
  ...
  >
    <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
      ...
      <IconButton
        ...
        onClick={() => {
          setOpenNav(!openNav);
          setExpandedDropdown(false); // Close the dropdown when toggling the mobile nav
        }}
      >
        {openNav ? (
          <svg
    ...
    <MobileNav open={openNav}>
      <div className="container mx-auto" style={navbarStyle}>
        {navList}
        <div className="flex items-center gap-x-1">
          <Button
            fullWidth
