...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <div className="text-xl">SECTION 1 – WHAT DO WE DO WITH YOUR INFORMATION?</div>  
      <p>
      When you purchase/donate something from our store/site, as part of the
      buying and selling process, we collect the personal information you give
      us such as your name, address and email address. When you browse our
      ...
      about your browser and operating system. Email marketing (if applicable):
      With your permission, we may send you emails about our store/site, new
      products and other updates.
        </p>
      <div className="text-xl">SECTION 2 – CONSENT</div>    
      ...
      arrange for a delivery or return a purchase, we imply that you consent to
      our collecting it and using it for that specific reason only. If we ask
      for your personal information for a secondary reason, like marketing, we
      will either ask you directly for your expressed consent, or provide you
      with an opportunity to say no. How do I withdraw my consent? If after you
      ...
      information, at anytime, by contacting us at iskcondhanbad@gmail.com
      <div className="text-xl">SECTION 3 – DISCLOSURE</div>  
      We may disclose your personal information if we are required by law to do
      so or if you violate our Terms of Service.
      <div className="text-xl">SECTION 4 – PAYMENT</div>  
      ...
      https://razorpay.com
      <div className="text-xl">SECTION 5 – THIRD-PARTY SERVICES</div>  
      ...
      <div className="text-xl">SECTION 6 – SECURITY</div>  
      ...
      <div className="text-xl">SECTION 9 – CHANGES TO THIS PRIVACY POLICY</div>  
      ...
      you. QUESTIONS AND CONTACT INFORMATION If you would like to: access,
      correct, amend or delete any personal information we have about you,
      register a complaint, or simply want more information contact our Privacy
      Compliance Officer at iskcondhanbad@gmail.com or by mail at ISKCON
      Dhanbad, 21, Dhruv Singh Colony, Rahargora, Near SBI, Dhaiya, Dhanbad,
      Jharkhand
    </>
  );
};
