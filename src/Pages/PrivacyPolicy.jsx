...
const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto mt-8 px-4">
      ...
      {/* SECTION 1 */}
      <section>
        <h2 className="text-2xl font-semibold mb-4">WHAT DO WE DO WITH YOUR INFORMATION?</h2>
        <p>
          When you purchase/donate something from our store/site, as part of the buying and selling process,
        ...
        <p>
          Email marketing (if applicable): With your permission, we may send you emails about our store/site,
      ...
      <section>
        ...
        <p>
          ...
          arrange for delivery, or return a purchase, we imply that you consent to our collecting it and using it for that specific reason only.
        </p>
        <p>
        ...
        <p>
          ...
          use, or disclosure of your information, at any time, by contacting us at iskcondhanbad@gmail.com
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          For more insight, you may also want to read the terms and conditions of Razorpay on <a href="https://razorpay.com" target="_blank" rel="noopener noreferrer">https://razorpay.com</a>
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          For these providers, we recommend that you read their privacy policies so you can understand the manner in which your personal information
      ...
      {/* SECTION 8 */}
      <section>
        <h2 className="text-2xl font-semibold mb-4">AGE OF CONSENT</h2>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          <a href="mailto:iskcondhanbad@gmail.com">iskcondhanbad@gmail.com</a> or by mail at ISKCON Dhanbad, 21, Dhruv Singh Colony, Rahargora, Near SBI, Dhaiya, Dhanbad, Jharkhand
        </p>
      </section>
    </div>
  );
